...
# Creating a class for the Dept First Search
class DSFplanner:
    ...
    def __init__(self, ox, oy, resolution, robotRadius):
        ...
        #picking the motion model of choice
    ...
    def planning(self, sx, sy, gx, gy):
        """
        Path planning for Depth First search 
        ...
        if show_animation: 
            plt.scatter(start_node.x, start_node.y, s=400, c='purple', marker='s')
            plt.scatter(goal_node.x, goal_node.y, s=400, c='green', marker='s')                           

        #Create 2 dictionaries, open and closed set, add start node to both
        ...
        while 1:
            ...
            # remove current from open_set and get its index . Note, the list uses LIFO
            ...
            if choice ==2: #tree search
                #expand nodes using motion model
    ...
    def calc_final_path(self, goal_node, closedset):
        ...
        rx, ry = [self.calc_grid_position(goal_node.x, self.min_x)], [
         ...
         # using index to retrieve node closedset since it is a dict    
